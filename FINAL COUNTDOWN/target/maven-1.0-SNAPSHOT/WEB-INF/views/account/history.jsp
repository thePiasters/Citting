...
<div class="container">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="active"><a href="http://localhost:8080/history">Review Visited Places</a></li>
    ...
    <div class="wrapper">
        ...
        <div class="wrapper">
            ...
            <c:forEach items="${visitedPlaces}" var="userPlace">
                ${userPlace.place.name}
                <a href="http://localhost:8080/deleteFromHistory/${userPlace.place.id}">Remove</a>
